...
class Backtester:
    ...
    def load_data(self):
        ...
        print("Minimum Jump: " + str(self.min_step))
    ...
    def match_old_orders(self, tick1, tick2):
        ...
        # Intepreted volume: key = price, value = volume
        traded_dict = self.analyze_between_tick(tick1, tick2)
    ...
    # Called when new orders were created
    ...
    def process_between_tick_result(self, result_dict, base, min_tick):
        """
        ...
        for key, value in result_dict.items():
            if value != 0:
                new_result_dict[base + key * min_tick] = int(value)
    ...
    def analyze_between_tick(self, tick1, tick2):
        ...
        for price_posit in price_list:
            ...
            if price_posit not in tick1_dict:
                bucket_dict[spot] = 0
            elif price_posit not in tick2_dict or tick1_dict[price_posit] * tick2_dict[price_posit] <= 0:
    ...
    def run(self, strategy):
        ...
        tick_count = 0 # Keep track of index position
